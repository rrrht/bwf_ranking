...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference("Tournament.count") do
      post tournaments_url, params: { tournament: { grade: @tournament.grade, name: @tournament.name, start_date: @tournament.start_date } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { grade: @tournament.grade, name: @tournament.name, start_date: @tournament.start_date } }
